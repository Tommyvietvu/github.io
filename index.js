...
function draw() {
  if (isGameOver) {
    ...
    if (keyDown(LEFT_ARROW) && player.position.x > (playerImage.width)) {
      player.position.x -= 5;
    }
